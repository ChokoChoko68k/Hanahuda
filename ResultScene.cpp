...
void ResultScene::Draw() {
	...
	if (count == SCREEN_WIDTH / 2) {
		...
		DrawExtendFormatString(SCREEN_WIDTH / 2 - 180, 230, 2.0, 2.0, KINAKAJIS, "%s：    %d点", "競技者０", score_player0);
		DrawExtendFormatString(SCREEN_WIDTH / 2 - 180, 280, 2.0, 2.0, KINAKAJIS, "%s：    %d点", "競技者１", score_player1);
